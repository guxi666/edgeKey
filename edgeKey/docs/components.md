...
```components/AppButton.vue#L1-3
<AppButton href="/guxi/products/new" variant="primary">新建商品</AppButton>
<AppButton :href="`/guxi/orders/${id}`" variant="outline" size="xs">详情</AppButton>
```
...
```pages/guxi/cards/+Page.vue#L1-30
<script setup lang="ts">
...
```pages/guxi/products/ProductForm.vue#L100-120
<script setup lang="ts">
import { ref } from "vue";
...
```pages/guxi/products/RichTextEditor.vue#L230-250
<script setup lang="ts">
import { ref } from "vue";
import FilePickerModal from "../../../components/FilePickerModal.vue";
...
```pages/guxi/settings/+Page.vue#L70-90
<script setup lang="ts">
import { ref } from "vue";
import FilePickerModal from "../../../components/FilePickerModal.vue";
