...
CF Store这是专为“懒人”准备的发卡系统。 它可以运行 Cloudflare 上！ 不仅能实现 0 成本起步，还能享受全球加速和顶级DDOS防护，所有的这些点击就送（一键部署上线）

## 【3 分钟上手指南】

准备Cloudflare(https://dash.cloudflare.com/)、Github账号(https://github.com/)，先全部登录上去（没有账号的看后面注册教程）

- 打开GitHub仓库：https://github.com/your-account/your-repo
...
在你的小站网址比如 cf-store.xxx.workers.dev 后面加上 /guxi ，就是你的后台登录地址，假设我的小站地址是 cf-store.12345.workers.dev
那么登录地址就是cf-store.12345.workers.dev/guxi，  输入用户名 admin，密码 admin123456 即可登录后台上架商品。
