...
6. `pages/guxi/payments/forms/XxxForm.vue` — 新建专用字段表单组件
7. `pages/guxi/payments/PaymentConfigCard.vue` — `formMap` 加新组件，`extraFields` 初始化加新分支
8. `pages/guxi/payments/+Page.vue` — 加 tab
9. `pages/guxi/payments/savePaymentConfig.telefunc.ts` — 加专用字段参数
