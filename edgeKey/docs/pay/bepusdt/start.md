...
这两个地址的路由部分 **严格按要求填写**，只需将域名部分替换为您实际部署的 CF Store 服务器地址：
...
- [CF Store 项目主页](https://github.com/your-account/your-repo)
