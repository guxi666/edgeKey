    ...
    <div class="modal-box w-11/12 max-w-5xl max-h-[80vh] flex flex-col">
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div v-else-if="files.length === 0" class="text-center py-12">
          ...
          <a href="/guxi/media" target="_blank" class="btn btn-primary btn-sm mt-4">
      ...
      <div class="modal-action">
        <a href="/guxi/media" class="btn btn-outline btn-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
          </svg>
          上传文件
...
import { onGetMediaList } from "../pages/guxi/media/getMediaList.telefunc";
